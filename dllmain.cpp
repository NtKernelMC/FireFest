/*
    ...
    --- FireFest v14 RELEASE build 1415
    - Исправлен недочет в луа инжекторе после реконнекта
    - Сделано анти-смещение номеров скриптов для луа инжектора
    - Теперь луа скрипты можно закидать в папку фаерфеста
*/
#include <Windows.h>
#include <stdio.h>
#include <thread>
