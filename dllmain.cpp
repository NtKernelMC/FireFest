/*
    ---- FireFest v14 BETA build 1409 by NtKernelMC
    ...
    + Добавлен дампер set и get (element data)
    + Добавлен внутриигровой инжектор клиентских луа скриптов 
    + Сделан режим авто-поиска скриптов подходящих для замены
